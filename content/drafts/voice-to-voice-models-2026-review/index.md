...
featureAlt: "Three architectural approaches to speech-to-speech AI: audio-native full-duplex, Thinker-Talker separation, and the classic ASR-LLM-TTS cascade."
...
- **1,217 hours of real human conversations** from the Fisher English corpus, which contains genuine backchanneling, overlapping speech, hesitations, and the natural messiness of human interaction. These were back-annotated with personality and role descriptions using GPT-OSS-120B.
- **2,250 hours of synthetic dialogues** covering customer service and assistant scenarios, generated by Qwen3-32B and synthesized into audio with ChatterBox TTS. These conversations are artificial but cover a wide range of roles, topics, and instruction types.
...
- Script-following and tool-calling capabilities remain stronger in `gpt-realtime` as of early 2026.
...
*Benchmarks referenced: FullDuplexBench ([arxiv 2503.04721](https://arxiv.org/abs/2503.04721)), ServiceDuplexBench (NVIDIA, forthcoming). PersonaPlex latency numbers are NVIDIA-reported; independent reproduction has not been published at time of writing.*
