...
This is a  content for linkedin carousel, it is a presentation of the new mental model of the agentic systems, and the old mental model of the REST APIs.
...
### Slide 3
Headline: The better mental model: dynamic teams assembled around a problem
Supporting copy:
...
### Slide 4
Headline: What changes when you adopt that model
Supporting copy:
...
### Slide 5
Headline: Why demos work but production gets messy
Supporting copy: In demos, the visible star is the agent. In production, the hard part is everything around it:
- registry
- communication layer
- durable execution
- evaluation loop
...
### Slide 6
Headline: The real enterprise question
Supporting copy: If you're building agents today, which layer is least solved in your stack?
- discoverability
- orchestration
- budget control
- authorization
...
Topic covered by published posts (Mar 21 auth image, Mar 27 agent demos carousel, Apr 12 demos vs production text). Not worth a separate carousel — content would overlap.